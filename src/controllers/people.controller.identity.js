...
exports.searchPeople = async (req, res) => {
    try {
      ...
      console.log('=== PEOPLE SEARCH DEBUG - REQUEST PARAMETERS ===');
      console.log('Query params:', {
        q, country, accountType, city, categoryId, cats, subcategoryId, goalId,
        experienceLevel, connectionStatus, identityIds, audienceCategoryIds,
        audienceSubcategoryIds, audienceSubsubCategoryIds, viewOnlyConnections,
        industryIds, bidirectionalMatch, bidirectionalMatchFormula, limit, offset
      });
      console.log('Current user ID:', req.user?.id || 'anonymous');
